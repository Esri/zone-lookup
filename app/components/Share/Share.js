    ...
    var Share = /** @class */ (function (_super) {
        ...
        Share.prototype._processShareItem = function (event) {
            ...
            this._handles.add(watchUtils.whenOnce(this, 'shareUrl', function () {
                ...
                var title = portalItem ? replace_1.replace(i18n.urlTitle, { title: portalItem.title }) : null;
                var summary = portalItem ? replace_1.replace(i18n.urlSummary, { summary: portalItem.snippet }) : null;
