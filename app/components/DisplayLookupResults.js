    ...
    var DisplayLookupResults = /** @class */ (function (_super) {
        ...
        DisplayLookupResults.prototype.render = function () {
            var loader = this.state === 'loading' ? (widget_1.tsx("div", { key: "loader", class: "loader is-active padding-leader-3 padding-trailer-3" },
                ...
                widget_1.tsx("div", { key: "loaderText", class: "loader-text" }, "Loading..."))) : null;
            ...
            var isEmpty = !Array.isArray(this._features) || this._features.length === 0 ? true : false;
            var errorText = null;
            if (isEmpty && ready) {
            ...
            var toggleContentLinks = !isEmpty && ready && this._features.length > 2 ? (widget_1.tsx("div", { key: "toggleBar", class: this.classes(CSS.toggleContentTools, CSS.calciteStyles.leaderHalf) },
            ...
            var accordion = ready ? (widget_1.tsx("div", { key: "accordion" },
                ...
                widget_1.tsx("div", { key: "detailAccordion", bind: this, afterCreate: this._addDetailAccordion }))) : null;
            return (widget_1.tsx("div", { key: "loader" },
                loader,
                toggleContentLinks,
                !isEmpty && ready && resultsPanelPreText ? (widget_1.tsx("p", { key: "preText", class: CSS.messageText, innerHTML: resultsPanelPreText })) : null,
                accordion,
                !isEmpty && ready && resultsPanelPostText ? (widget_1.tsx("p", { key: "postText", class: CSS.messageText, innerHTML: resultsPanelPostText })) : null));
        };
        DisplayLookupResults.prototype._addDetailAccordion = function (container) {
            var _this = this;
            var _a = this, _features = _a._features, config = _a.config, view = _a.view;
        ...
        DisplayLookupResults.prototype.queryFeatures = function (location, distance) {
            ...
            return promiseUilts.eachAlways(Promise.all(promises).then(function (results) {
                var features = [];
                results.forEach(function (queryResults) {
        ...
        DisplayLookupResults.prototype._createQuery = function (layer, location) {
            ...
            var query = layer && layer.layer && typeof layer.layer['createQuery'] === 'function'
                ? layer.layer.createQuery()
                : new Query_1.default();
            var layerGeometryType = layer && layer.layer ? layer.layer.geometryType : null;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, geometryUtils.bufferGeometry({
                                    location: location,
                                    portal: portal,
                                    distance: this.distance,
                                    unit: units
        ...
        DisplayLookupResults.prototype._searchHighlight = function (graphic) {
            ...
            if (this.searchLayer && lookupType === 'geometry') {
                ...
                graphic.layer &&
                    ...
                    queryFilter.where = this.searchLayer.layer.objectIdField + " = " + graphic.attributes[this.searchLayer.layer.objectIdField];
                }
                else {
        ...
        DisplayLookupResults.prototype._sortFeatures = function (features) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, lookupType, includeDistance, units, portal;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this.config, lookupType = _a.lookupType, includeDistance = _a.includeDistance, units = _a.units, portal = _a.portal;
                            if (!(lookupType && lookupType === 'distance' && includeDistance)) return [3 /*break*/, 2];
                            // add distance val to the features and sort array by distance
                            return [4 /*yield*/, geometryUtils.getDistances({
        ...
        DisplayLookupResults.prototype.clearResults = function () {
            var hideLookupLayers = this.config.hideLookupLayers;
            ...
            this.lookupLayers &&
                this.lookupLayers.forEach(function (layer) {
                    layer.effect = null;
                    layer.filter = hideLookupLayers ? new FeatureFilter_1.default({ where: '1=0' }) : null;
                });
            if (this.searchLayer) {
                this.searchLayer.effect = null;
                this.searchLayer.filter = hideLookupLayers ? new FeatureFilter_1.default({ where: '1=0' }) : null;
            }
