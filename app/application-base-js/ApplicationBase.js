...
*/
define(["require", "exports", "tslib", "esri/core/promiseUtils", "esri/identity/IdentityManager", "esri/identity/OAuthInfo", "esri/portal/Portal", "esri/portal/PortalItem", "esri/portal/PortalQueryParams", "esri/config", "esri/intl"], function (require, exports, tslib_1, promiseUtils_1, IdentityManager_1, OAuthInfo_1, Portal_1, PortalItem_1, PortalQueryParams_1, config_1, intl_1) {
    "use strict";
    IdentityManager_1 = tslib_1.__importDefault(IdentityManager_1);
    OAuthInfo_1 = tslib_1.__importDefault(OAuthInfo_1);
    ...
    var ApplicationBase = /** @class */ (function () {
        ...
        function ApplicationBase(options) {
            ...
            var applicationBaseSettings = typeof settings === "string"
                ? JSON.parse(settings)
                : settings;
            var configMixin = tslib_1.__assign(tslib_1.__assign({}, defaultConfig), applicationConfig);
            var settingsMixin = tslib_1.__assign(tslib_1.__assign({}, defaultSettings), applicationBaseSettings);
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            paramOptions = tslib_1.__assign({ query: "group:\"" + groupId + "\" AND -type:\"Code Attachment\"", sortField: "modified", sortOrder: "desc", num: 9, start: 1 }, itemParams);
        ...
        ApplicationBase.prototype._mixinSettingsDefaults = function (settings) {
            ...
            settings.environment = tslib_1.__assign({ isEsri: false, webTierSecurity: false }, userEnvironmentSettings);
            var itemParams = {
                sortField: "modified",
                sortOrder: "desc",
                num: 9,
            ...
            settings.group = tslib_1.__assign({ default: "908dd46e749d4565a17d2b646ace7b1a", fetchInfo: true, fetchItems: true, fetchMultiple: true, itemParams: itemParams }, userGroupSettings);
            settings.portal = tslib_1.__assign({ fetch: true }, userPortalSettings);
            settings.webMap = tslib_1.__assign({ default: "1970c1995b8f44749f4b9b6e81b5ba45", fetch: true, fetchMultiple: true }, userWebmapSettings);
            settings.webScene = tslib_1.__assign({ default: "e8f078ba0c1546b6a6e0727f877742a5", fetch: true, fetchMultiple: true }, userWebsceneSettings);
        };
        ...
        ApplicationBase.prototype._mixinAllConfigs = function (params) {
            ...
            return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, config), appConfig), localConfig), urlConfig);
        };
